...
public class bombay_cat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bombay_cat);
        ...
        bombaycat= findViewById(R.id.bombaycat);
    ...
    private void addedtocart() {
        ...
        cartMap.put("product","bombay_Cat");
...
//        });
        firestore.collection("Petshopee")
                ...
                .document("9mYenlzaXcSUPt0Vws2p") // Specify your custom document ID here
                .set(cartMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(bombay_cat.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(bombay_cat.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
