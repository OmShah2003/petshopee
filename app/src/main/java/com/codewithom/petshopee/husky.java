...
public class husky extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        husky= findViewById(R.id.husky_dog);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(husky.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(husky.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
