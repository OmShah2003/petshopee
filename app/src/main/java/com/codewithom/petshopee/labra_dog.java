...
public class labra_dog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        labradog= findViewById(R.id.labra_dog);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(labra_dog.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(labra_dog.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
