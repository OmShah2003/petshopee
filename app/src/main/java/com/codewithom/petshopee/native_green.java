...
public class native_green extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_green);
        ...
        green= findViewById(R.id.native_green);
    ...
    private void addedtocart() {
        ...
        cartMap.put("product","native green");
...
//        });
        firestore.collection("Petshopee")
                ...
                .document("qGpTn0EnP0WMy1mkBhS1") // Specify your custom document ID here
                .set(cartMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(native_green.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(native_green.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
