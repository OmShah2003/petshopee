...
public class rottweiler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rotweiler1= findViewById(R.id.rottweilerlayout);
...
//        });
        firestore.collection("Petshopee")
                ...
                .document("bbfF5O1vNCKmfqI27Jqg") // Specify your custom document ID here
                .set(cartMap)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(rottweiler.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
