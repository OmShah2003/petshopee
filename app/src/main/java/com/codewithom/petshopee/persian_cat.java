...
public class persian_cat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        persian_cat= findViewById(R.id.persiancat);
    ...
    private void addedtocart() {
        ...
        cartMap.put("product","persian_cat");
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(persian_cat.this, "Added to Cart", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(persian_cat.this, "Failed to add to Cart", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
